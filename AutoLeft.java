...
public class AutoLeft extends LinearOpMode {
    ...
    private static final double DRIVE_GEAR_REDUCTION = 0.866;
    private static final double WHEEL_DIAMETER_INCHES = 10 / 2.54;
    ...
    private static final double DISTANCE_STONE_TO_ANOTHER = 8;                   //DISTANCIA EN PULGADAS
